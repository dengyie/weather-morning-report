...
天气早报现在是一个 **OpenPet JavaScript 插件**，用于输出简短的天气简报。
...
- 插件使用单文件 `openpet-plugin/index.js` 作为入口。
- release 压缩包只包含 `plugin.json`、`config.schema.json`、`index.js` 和 `README.md`。
