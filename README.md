...
Weather Morning Report is an **OpenPet JavaScript plugin** for concise weather briefings.
...
- The plugin uses a single bundled `openpet-plugin/index.js` entry.
- The release archive contains only `plugin.json`, `config.schema.json`, `index.js`, and `README.md`.
